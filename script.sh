...
if [[ $# -lt 1 ]]; then
    ...
    echo "                  $0 -p asd123 dec 'encrypted seed text' | script decrypt using password asd123"
    echo "                  $0 -p asd123 dec 'my qr code.png' | scrypts scans file 'my qr code.png' and decrypt using password asd123"
    echo ""
    echo ""
    echo "                                  000000000           "
